...
export function formarLote(volumes,input,user,now=new Date().toISOString()){
 ...
 if(volumes.some(v=>v.beneficiador!=='00153'||v.equipe!=='A'||v.confirmadoAcesys))throw new Error('Somente materiais BENEFICIADOR 00153 / EQUIPE A pendentes podem formar lote.');
