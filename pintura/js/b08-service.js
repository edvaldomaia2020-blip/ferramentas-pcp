...
export const BENEFICIADOR_PINTURA='01533';
...
export const pertencePintura=v=>String(v?.beneficiadorOriginal??v?.beneficiador??'').trim()===BENEFICIADOR_PINTURA;
...
export function normalizeBeneficiador(beneficiadorIdOriginal,beneficiadorOriginal){const id=String(beneficiadorIdOriginal??'').trim(),codigo=String(beneficiadorOriginal??'').trim();return{beneficiador:codigo,beneficiadorFonte:'BENEFICIADOR',beneficiadorIdOriginal:id,beneficiadorOriginal:codigo};}
